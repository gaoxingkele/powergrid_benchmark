...
_id: `architectural_operator_substitution` · journal=`ieee-internet-of-things-journal` · primary_count=2_

**Plain alias**. _Substitute the operator or representation_

**Operational signature**. expensive operator → cheaper surrogate → preserve property

**When to apply (in `ieee-internet-of-things-journal`)**. When local accepted papers in this venue execute this move (see examples). Prefer composing with a journal-house pattern below.
...
## Local examples
- 15694 IEEE INTERNET OF THINGS JOURNAL, VOL. 8, NO. 21, NOVEMBER 1, 2021 (`ieee-internet-of-things-journal__2021__a…`) — bottleneck: detection reliability under noise/imbalance
- IEEE INTERNET OF THINGS JOURNAL, VOL. 8, NO. 21, NOVEMBER 1, 2021 15919 (`ieee-internet-of-things-journal__2021__r…`) — bottleneck: forecasting accuracy / uncertainty under nonstationarity
