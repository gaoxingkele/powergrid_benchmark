...
_id: `heterogeneous_decomposition` · journal=`mdpi-future-internet` · primary_count=1_
...
**When to apply (in `mdpi-future-internet`)**. When local accepted papers in this venue execute this move (see examples). Prefer composing with a journal-house pattern below.
...
## Local examples
- StegNet: Mega Image Steganography Capacity with (`mdpi-future-internet__2018__stegnet_mega…`) — bottleneck: forecasting accuracy / uncertainty under nonstationarity
