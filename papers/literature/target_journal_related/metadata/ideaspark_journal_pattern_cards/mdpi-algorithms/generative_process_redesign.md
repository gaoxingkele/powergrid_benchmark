...
_id: `generative_process_redesign` · journal=`mdpi-algorithms` · primary_count=2_
...
**When to apply (in `mdpi-algorithms`)**. When local accepted papers in this venue execute this move (see examples). Prefer composing with a journal-house pattern below.
...
## Local examples
- /gid00030/gid00035/gid00032/gid00030/gid00038/gid00001/gid00033/gid00042/gid00045/gid00001 (`mdpi-algorithms__2022__applying_simheuri…`) — bottleneck: optimization tractability / constraint satisfaction
- Citation: Tahir, N.U.A.; Zhang, Z.; (`mdpi-algorithms__2024__object_detection_…`) — bottleneck: forecasting accuracy / uncertainty under nonstationarity
