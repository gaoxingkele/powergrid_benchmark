...
_id: `unify_into_shared_representation` · journal=`mdpi-algorithms` · primary_count=1_

**Plain alias**. _Unify heterogeneous inputs in one space_

**Operational signature**. heterogeneous inputs → shared representation → uniform model
...
## Local examples
- Learning over Knowledge-Base Embeddings for Recommendation (`mdpi-algorithms__2018__learning_heteroge…`) — bottleneck: optimization tractability / constraint satisfaction
