...
_id: `generative_process_redesign` · journal=`mdpi-atmosphere` · primary_count=1_
...
**When to apply (in `mdpi-atmosphere`)**. When local accepted papers in this venue execute this move (see examples). Prefer composing with a journal-house pattern below.
...
## Local examples
- The Fire and Smoke Model Evaluation Experiment—A Plan for (`mdpi-atmosphere__2019__the_fire_and_smok…`) — bottleneck: forecasting accuracy / uncertainty under nonstationarity
