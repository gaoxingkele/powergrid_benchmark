...
_id: `structural_prior_encoding` · journal=`mdpi-atmosphere` · primary_count=1_

**Plain alias**. _Encode structure by construction_

**Operational signature**. known structure → bake into operators → satisfied by construction
...
## Local examples
- Regional and Urban-Scale Environmental Influences of Oceanic (`mdpi-atmosphere__2020__regional_and_urba…`) — bottleneck: sensing quality / atmospheric confounders
