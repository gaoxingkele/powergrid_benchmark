...
_id: `generative_process_redesign` · journal=`springer-discover-computing` · primary_count=2_
...
**When to apply (in `springer-discover-computing`)**. When local accepted papers in this venue execute this move (see examples). Prefer composing with a journal-house pattern below.
...
## Local examples
- The accessibility of digital technologies for people with visual (`springer-discover-computing__2024__the_a…`) — bottleneck: storage modeling / lifetime / market coupling
- RESEARCH Open Access (`springer-discover-computing__2025__penal…`) — bottleneck: forecasting accuracy / uncertainty under nonstationarity
