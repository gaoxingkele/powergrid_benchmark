...
Status: `public_rts_curtailment_v5_onset_eval`.
...
- DSTAR-GRU MAE `0.00769850` (std `0.00026278`, rank 4/12)
...
- ONSET MAE: `0.04875569` vs best baseline `0.04379054`
...
| 5 | LSTM | baseline | 0.00966282 | 0.173514 | 0.04379054 | 0.724201 | 0.02503223 |
| 6 | Ablation-NoRetrievalBank | ablation | 0.01240724 | 0.163099 | 0.04190934 | 0.696107 | 0.03114757 |
| 7 | Ablation-NoSiamese | ablation | 0.01281050 | 0.089172 | 0.04880844 | 0.541833 | 0.03528196 |
| 8 | kNN-RawFeature | baseline | 0.01281050 | 0.089172 | 0.04880844 | 0.541833 | 0.03528196 |
| 9 | MLP | baseline | 0.01294264 | 0.162302 | 0.04866386 | 0.631467 | 0.02911240 |
| 10 | Ablation-SmallBank | ablation | 0.01534389 | 0.042458 | 0.06937456 | 0.000000 | 0.04431182 |
| 11 | Ridge | baseline | 0.01984423 | 0.143426 | 0.04455398 | 0.434783 | 0.05038428 |
| 12 | Seasonal-24h | baseline | 0.02035887 | 0.076271 | 0.07043567 | 0.342105 | 0.04886620 |

### Horizon 24h

- DSTAR-GRU MAE `0.02054281` (std `0.00025532`, rank 8/12)
...
- ONSET MAE: `0.11082187` vs best baseline `0.10226666`
...
| 11 | Ridge | baseline | 0.02427802 | 0.235602 | 0.10648650 | 0.025157 | 0.04949261 |
| 12 | MLP | baseline | 0.02664181 | 0.206373 | 0.10226666 | 0.167563 | 0.04885908 |
