...
Status: public data benchmark `public_data_benchmark_v4_rolling_residual_hyg`. This result uses the cached OPSD 60-minute single-index load data and Python standard library implementation.
