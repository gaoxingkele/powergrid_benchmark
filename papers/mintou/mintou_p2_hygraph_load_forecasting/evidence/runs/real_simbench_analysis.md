...
Status: public data benchmark `public_data_benchmark_v3_short_horizon_gated_simbench_profiles`. This result uses cached SimBench load data and Python standard library implementation.
