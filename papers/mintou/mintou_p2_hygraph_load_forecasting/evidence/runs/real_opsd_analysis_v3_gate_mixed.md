...
- Proposed MAPE: `0.02298243`
- Best baseline: `Euclidean-GCN Ridge` with MAPE `0.02250389`
- Best ablation: `Ablation-NoCalendar` with MAPE `0.02068559`
- Relative gain over best baseline: `-2.08%`
- Relative gain over best ablation: `-9.99%`
- Proposed normalized MAE: `0.00906608`
...
- Relative normalized-MAE gain over best baseline: `-2.00%`
- Relative normalized-MAE gain over best ablation: `-7.03%`
- Current value signal: `needs_compliant_optimization`

## Horizon 24h

- Proposed MAPE: `0.04029453`
- Best baseline: `Weekly-168h` with MAPE `0.05632632`
- Best ablation: `Ablation-FixedCurvature` with MAPE `0.06915059`
- Relative gain over best baseline: `39.79%`
- Relative gain over best ablation: `71.61%`
- Proposed normalized MAE: `0.01668455`
...
- Relative normalized-MAE gain over best baseline: `44.15%`
- Relative normalized-MAE gain over best ablation: `55.13%`
