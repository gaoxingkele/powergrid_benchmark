...
- Proposed mean hypervolume proxy: `1.76296195`
- Best baseline: `Random Feasible` with `2.88748374`
- Best ablation: `Ablation-ShallowLocalSearch` with `1.77302497`
- Relative gain over best baseline: `-38.94%`
- Relative gain over best ablation: `-0.57%`
