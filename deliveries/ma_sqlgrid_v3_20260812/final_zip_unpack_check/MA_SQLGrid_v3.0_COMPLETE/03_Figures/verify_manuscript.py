...
def main() -> int:
    ...
    required = [
        ...
        "Science and Technology Research Project of State Grid Fujian Electric Power Co., Ltd.",
    ...
    prohibited = [
        ...
        "The exact funding-agency wording requires written author confirmation",
        "Confirmation of the exact funding-agency identity",
    ]
