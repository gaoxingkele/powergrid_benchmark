<!-- IEEE Access submission draft (Markdown content master).
     Main-text numerical results bind only to the completed, protocol-valid
     experiments/p1_ieee_access_upgrade_v2/run_manifest.json and the five
     Stage-3 paper tables recorded in statistics_provenance.json.
     Regenerate all paper-facing figures with manuscript/figures/make_figures.py.
     Version history, hashes, execution environment, and incident detail remain
     in supplementary/internal records. AUTHOR INPUT REQUIRED markers are
     author-controlled and must not be inferred. -->
...
![Figure 1. Frozen benchmark gate and onset support.](figures/fig_benchmark_overview.png)

**Fig. 1.** Manifest-bound temporal gate, target counts, and positive-onset support. Selection and calibration contain no positive onsets at either primary lag; the same zero-support condition holds at all three caps. Counts are delivery targets, not independent inferential units.
...
![Figure 2. Matched retrieval use case and controls.](figures/fig_architecture.png)

**Fig. 2.** GRU-LSR use case within the benchmark. Learned, raw, and randomized retrieval share the fit-only target bank and $k=8$ primary rule. Persistence, Seasonal-24h, and Ridge are external references. The target-hour direct transform is a privileged construction audit, not a forecaster.
...
![Figure 3. Primary paired MAE effects.](figures/fig_primary_effects.png)

**Fig. 3.** Paired primary-cap MAE effects over ten common seeds. Whiskers are predeclared seed-conditional intervals. They do not quantify uncertainty over hours, years, systems, operators, or deployments.
...
![Figure 4. Descriptive cap profile.](figures/fig_cap_profile.png)

**Fig. 4.** Selected learned retrieval minus Persistence MAE. Negative values favor selected learned retrieval. Persistence receives no seed-based p-value, and no cross-cap generalization is made.
...
1. **Retrospective visibility.** Issue timestamps, as-of mappings, release identifiers, and vintages are absent. The lags are not operational forecasts.
2. **Proxy target.** The SNSP-type rule does not produce observed curtailment, an operator action, dispatch, network feasibility, or an economic outcome.
3. **Single truncated sequence.** One RTS-GMLC system and the first 8760 of 8784 rows support every result; the sequence ends December 30.
4. **Onset inapplicability.** No selection or calibration cell has a positive onset. Test onset metrics remain diagnostic.
5. **Conditional statistics.** Training seeds are not randomized assignments. Seed and block intervals do not provide uncertainty across years or systems.
6. **Comparison budget.** Architectures share epochs and checkpoints but not parameter counts. $k=4,16,32$ and cross-cap results are descriptive; no alternative distance is evaluated.
7. **Point prediction and no deployment validation.** No probabilistic calibration is evaluated for GRU-LSR, and there is no operator, safety, physical, economic, or field validation.
...
RTS-GMLC is available from the GridMod repository [6]. The accepted evidence package is stored locally under `experiments/p1_ieee_access_upgrade_v2/`; no public repository URL or archival DOI is claimed until authors provide one. [AUTHOR INPUT REQUIRED: insert the public release URL and/or archival DOI before submission.]
...
[29] J. Zhang et al., "LoadSeer: Exploiting Tensor Graph Convolutional Network for Power Load Forecasting With Spatio-Temporal Characteristics," *IEEE Access*, vol. 12, pp. 190337–190346, 2024, doi: 10.1109/ACCESS.2024.3514174.
...
[31] M. H. Shams, H. Niaz, B. Hashemi, J. J. Liu, P. Siano, and A. Anvari-Moghaddam, "Artificial intelligence-based prediction and analysis of the oversupply of wind and solar energy in power systems," *Energy Conversion and Management*, vol. 250, Art. no. 114892, 2021, doi: 10.1016/j.enconman.2021.114892.

[32] H. Hadian and F. Naderkhani, "Multi-scale system-level forecasting of solar and wind curtailment using a wavelet-augmented transformer," *Sustainable Energy, Grids and Networks*, 2026, Art. no. 102496, doi: 10.1016/j.segan.2026.102496.

[33] M. Z. Heidrich, M. A. F. Reis, C. K. Yamaguchi, L. O. Seman, and S. F. Stefenon, "Patch-Based Transformer With Mixture of Experts and Conformal Inference for Curtailment Time Series Forecasting," *IEEE Access*, vol. 14, pp. 64144–64160, 2026, doi: 10.1109/ACCESS.2026.3686958.

[34] S. Han, S. Lee, M. Cha, S. O. Arik, and J. Yoon, "Retrieval Augmented Time Series Forecasting," in *Proc. 42nd Int. Conf. Machine Learning*, PMLR, vol. 267, pp. 21774–21797, 2025. [Online]. Available: https://proceedings.mlr.press/v267/han25d.html

[35] S. Yang, D. Wang, H. Zheng, and R. Jin, "TimeRAG: Boosting LLM Time Series Forecasting via Retrieval-Augmented Generation," in *Proc. IEEE ICASSP*, pp. 1–5, 2025, doi: 10.1109/ICASSP49660.2025.10889933.

[36] S. Hussain, A. Ali, S. A. Qadir, and F. Baig, "Contextual retrieval-augmented tree ensemble boosting for multi-horizon solar PV power forecasting," *Energy and AI*, vol. 25, Art. no. 100855, 2026, doi: 10.1016/j.egyai.2026.100855.

[37] M. Borunda, L. Conde-López, G. Ruiz-Chavarría, G. Lopez Lopez, V. M. Alvarado, and E. de J. Carrera Avendaño, "Advances in Similar Day Methods for Short-Term Load Forecasting for Power Systems," *Forecasting*, vol. 8, no. 2, Art. no. 32, 2026, doi: 10.3390/forecast8020032.

[38] Q. Tan, Y. Chen, M. Li, R. Gu, Y. Su, and X.-P. Zhang, "SynTSBench: Rethinking Temporal Pattern Learning in Deep Learning Models for Time Series," in *Proc. 39th Conf. Neural Information Processing Systems, Datasets and Benchmarks Track*, 2025, doi: 10.52202/085713-4860.
