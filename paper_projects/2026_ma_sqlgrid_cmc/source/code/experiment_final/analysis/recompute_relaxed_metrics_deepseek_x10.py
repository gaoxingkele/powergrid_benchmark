#!/usr/bin/env python3
"""Recompute strict and relaxed execution metrics for the deepseek x10 run.

Same logic as recompute_relaxed_metrics_deepseek.py (strict / set_exact /
set_relaxed), pointed at outputs_deepseek_x10/ and the x10 database
(data/griddb_maintenance_v2_x10). No model calls are made.
"""
...
DATA_DIR = SOURCE_DIR / "data" / "griddb_maintenance_v2_x10"
OUT_DIR = EXPERIMENT_DIR / "outputs_deepseek_x10"
...
def main() -> None:
    ...
    }, "dataset": "data/griddb_maintenance_v2_x10", "conditions": {}}
    ...
    out = HERE / "relaxed_metrics_deepseek_x10.json"
