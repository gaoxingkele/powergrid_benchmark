...
class CalibrationTests(unittest.TestCase):
    ...
    def test_dev_hash_is_pinned(self):
        manifest = json.loads((Path(__file__).resolve().parent / "RUN_MANIFEST.json").read_text(encoding="utf-8"))
        self.assertEqual(manifest["data_boundary"]["dev_sha256"], calibration.EXPECTED_DEV_SHA256)
