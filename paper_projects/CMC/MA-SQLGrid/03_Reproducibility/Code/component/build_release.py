...
the frozen aggregator so the release is an independent recomputation.
"""
...
def main():
    ...
    canonical = {"schema_version": "ma-sqlgrid-component-canonical-release-v1",
        ...
        "reporting_constraints": ["Qwen E1 has a positive frozen-state execution-equality effect under the documented frozen rule; Granite E1 does not.",
