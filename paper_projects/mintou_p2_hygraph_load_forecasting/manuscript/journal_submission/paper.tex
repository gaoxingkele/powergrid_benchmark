...
\tightlist
\item
  \textbf{TemporalOnly:} removes the aggregation module entirely; the head sees only \(h_i\) and the four sequence-phase features. This is the switch that tests whether cross-series aggregation contributes at all.
\item
...
The middle three switches jointly probe the \emph{form} of the aggregation weights; TemporalOnly probes the \emph{existence} of aggregation; the no-sequence-phase switch probes the orthogonal phase-feature channel.
