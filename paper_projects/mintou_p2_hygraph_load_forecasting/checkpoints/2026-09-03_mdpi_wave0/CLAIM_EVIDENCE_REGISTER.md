...
| P4-C06 | A meaningful graph can be constructed without leakage. | FUTURE_HYPOTHESIS | No accepted graph-data mapping has been frozen. | “We evaluate physical, hierarchical, or training-only functional graphs.” | Must pass provenance, time split, node/edge, and leakage audits. |
