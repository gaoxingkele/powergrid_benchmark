...
| Optimization-loop workload quantity | $40\times80\times4+8\times40\times16=17{,}920$ versus $40\times80\times16=51{,}200$. | Static plan--scenario objective-row arithmetic for active-set union selection plus screening rounds. Reference-bound construction and held-out final-front evaluation are excluded from both counts, so this is not a full-pipeline call budget. No runtime call counter is implemented; no wall-clock claim follows. |
