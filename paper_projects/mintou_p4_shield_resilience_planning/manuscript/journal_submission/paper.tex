...
\scriptsize
\setlength{\tabcolsep}{3pt}
\caption{AC validation summary over six networks (108 cases per method).}\label{tab:6}
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X@{}}
\toprule
...
\caption{Original SimBench-family AC slice. (a) AC-feasible rate over 72 network-by-scenario cases and over stress scenarios only; the dashed line is the no-plan reference. (b) Mean maximum line loading. The cross-family extension is reported in Table 6 and Figure 9.}\label{fig:6}
\end{figure*}
...
\item
  \textbf{A cautionary baseline result.} Cost-first Deterministic Planning attains only a 0.417 AC-feasible rate and mean maximum loading 132.0\%, because cheap actions add load-side assets without relieving binding corridors. Its loss value is also the largest in Table 6.
\end{enumerate}
...
\footnotesize
\setlength{\tabcolsep}{3pt}
\caption{Selected pooled quality--cost readouts from the archived run records.}\label{tab:7}
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X@{}}
\toprule
...
\footnotesize
\setlength{\tabcolsep}{3pt}
\caption{Mechanism-level decision record.}\label{tab:8}
