...
\dateaccepted{}
\datepublished{}
\Title{SHIELD-MOEA: Scenario Screening with Disjoint Evaluation for Proxy-Based Distribution-Network Resilience Planning}
...
\subsection{Repair Drives the Resolved Gain; Screening Reduces Optimization-Loop Rows}\label{repair-drives-the-resolved-gain-screening-reduces-optimization-loop-rows}
...
\subsection{Screening Quality--Workload and Resilience-Composition Diagnostics}\label{screening-qualityworkload-and-resilience-composition-diagnostics}
...
\bibitem{ref42} Zhang, L.; Zheng, J.; Zhang, Z.; Ni, S.; Wu, G. CARS-MODE: Constraint-Aware Repair and Strategy-Pool Multi-Objective Differential Evolution on a SimBench-Derived Mixed-Voltage Portfolio Proxy. Unpublished manuscript, 2026; available to editors and reviewers on request.
