...
TARGET = WORKSPACE / ".c2ges_clean_unpack_03_author_metadata"
...
def main() -> None:
    ...
    pixel_equal = (
        ...
        and len(original_pages) == len(rebuilt_pages) == 14
        ...
        failures.append(
            {
                "rebuilt_pdf_content_mismatch": {
                    ...
                    "pixel_equal_14_pages": pixel_equal,
                }
            }
        )
    ...
    receipt = {
        ...
        "pdf_reproduction_note": "Raw PDF IDs can depend on the absolute build path; acceptance requires identical bytes length, extracted text, and all 14 rendered page pixels when the raw hash differs.",
